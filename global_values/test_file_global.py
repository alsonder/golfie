...
from create_path import nearest_neighbor, a_star_search, calculate_turn_points
...
turnPoints = calculate_turn_points(path, 3)
...
visualize_grid(grid, aruco, [aruco,goal], turnPoints)
