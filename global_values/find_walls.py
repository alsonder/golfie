...
# Load the image
img = cv2.imread('global_values/test_image.png')
...
# Output all line pixel coordinates as a single array
print(all_line_pixels)

# Optionally display the image with lines
